  ...
  return (
    <div className="space-y-20 pb-12">
      ...
      <section className="relative">
        <div className="absolute inset-0 bg-gradient-to-br from-primary-100 to-secondary-100 opacity-50 rounded-3xl"></div>
        <div className="relative z-10 py-16 sm:py-24 px-4 sm:px-16 rounded-3xl overflow-hidden">
          <div className="max-w-3xl">
            ...
            >
              Your Ultimate <span className="text-primary-600">Calculator</span> Toolkit
            </motion.h1>
            <motion.p 
          ...
          <div className="absolute left-0 bottom-0 translate-y-1/3 -translate-x-1/4 opacity-20 md:opacity-30">
            ...
            >
              <svg width="250" height="250" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="30" y="20" width="140" height="160" rx="15" fill="#8B5CF6"/>
                <rect x="45" y="40" width="110" height="30" rx="5" fill="#F5F3FF"/>
      ...
      <section>
        <div className="text-center mb-12">
          ...
          <motion.p 
            ...
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            We've got all the tools you need to make calculations quick and accurate.
          </motion.p>
        </div>
      ...
      <section className="bg-gray-50 py-12 px-4 sm:px-8 rounded-2xl">
        <div className="text-center mb-12">
          ...
          <motion.p 
            ...
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            Using Allin1Calculator is simple, intuitive, and designed for everyone.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-600">Select from our wide range of calculator tools based on your needs.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600">Input the required values for your calculation using our intuitive interface.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600">View your results instantly, with visualizations where applicable.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="text-center">
        <motion.div 
          ...
          transition={{ duration: 0.5 }}
        >
          <h2 className="text-3xl font-display font-bold text-gray-900 mb-4">Ready to Get Started?</h2>
          <p className="text-lg text-gray-600 mb-8">
            Explore our calculator tools and make your calculations quick and easy.
          </p>
          <Link 
            to="/basic" 
