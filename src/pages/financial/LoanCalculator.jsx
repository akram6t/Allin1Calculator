...
const LoanCalculator = () => {
  ...
  const calculateAmortizationSchedule = (principal, rate, time, monthlyPayment) => {
  ...
  const getYearlyAmortizationData = () => {
    ...
    for (let i = 0; i < years; i++) {
      ...
      const endMonth = Math.min(startMonth + 11, amortizationSchedule.length - 1);
      ...
      for (let j = startMonth; j <= endMonth; j++) {
        if (amortizationSchedule[j]) {
          yearlyPrincipal += parseFloat(amortizationSchedule[j].principalPayment);
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-3xl font-display font-bold text-center mb-6">Loan EMI Calculator</h1>
          ...
          {monthlyPayment && (
            ...
            >
              ...
              {showInfo && (
                ...
                >
                  <h3 className="font-medium text-gray-800 mb-2">Understanding Loan EMI Calculation:</h3>
                  <p className="mb-2">
                    EMI stands for Equated Monthly Installment. It's the amount you pay every month toward your loan, which includes both principal and interest components.
                  </p>
                  <p className="mb-2">
                    The EMI is calculated using the formula: EMI = P × r × (1 + r)ⁿ ÷ [(1 + r)ⁿ - 1], where:
                  </p>
                  <ul className="list-disc list-inside space-y-1 mb-2 pl-4">
                    <li>P = Principal loan amount</li>
                    <li>r = Monthly interest rate (annual rate ÷ 12 ÷ 100)</li>
                    <li>n = Total number of monthly installments (loan term in years × 12)</li>
                  </ul>
                  <p>
                    As you progress through your loan term, the proportion of principal to interest in each EMI changes. Initially, a larger portion goes toward interest, but this gradually shifts toward principal repayment.
                  </p>
                </motion.div>
              )}
            </motion.div>
        ...
        <div className="guide-section mt-12">
          <h2 className="text-xl font-semibold mb-4">Loan EMI Calculator Guide</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ol className="space-y-2 text-gray-700 list-decimal list-inside">
                ...
                <li>Results will calculate automatically, showing your monthly payment and total costs</li>
                <li>View the amortization schedule to see how payments are distributed over time</li>
              </ol>
            </div>
            <div>
              <h3 className="text-lg font-medium mb-2">Understanding the Results</h3>
              <ul className="space-y-2 text-gray-700">
                <li><span className="font-medium">Monthly Payment:</span> The fixed amount you'll pay each month</li>
                <li><span className="font-medium">Total Payment:</span> The sum of all payments over the entire loan term</li>
                <li><span className="font-medium">Total Interest:</span> The total cost of borrowing (Total Payment - Principal)</li>
                <li><span className="font-medium">Amortization Schedule:</span> Month-by-month breakdown of payments</li>
              </ul>
            </div>
          </div>
          <div className="mt-6">
            <h3 className="text-lg font-medium mb-2">Tips for Loan Management</h3>
            <ul className="space-y-1 text-gray-700 list-disc list-inside">
              <li>Making extra payments toward principal can significantly reduce your total interest costs</li>
              <li>Compare loans with different terms to find the right balance between monthly payment and total cost</li>
              <li>Lower interest rates have a major impact on long-term loans</li>
              <li>Consider factors beyond EMI, such as prepayment penalties and processing fees</li>
            </ul>
          </div>
        </div>
      </motion.div>
