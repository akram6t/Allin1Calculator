...
const TaxCalculator = () => {
  ...
  const calculateTaxes = () => {
    ...
    const taxableIncome = Math.max(0, incomeValue - standardDeduction[filingStatus]);
    ...
    for (let i = 0; i < currentBrackets.length; i++) {
      ...
      if (taxableIncome > bracket.min) {
        const taxableInBracket = Math.min(bracket.max, taxableIncome) - bracket.min;
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-3xl font-display font-bold text-center mb-6">Tax Calculator</h1>
          ...
          {taxResults && (
            ...
            >
              <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 mb-6">
                  <div>
                    ...
                    <p className="text-xl font-bold">{formatCurrency(taxResults.income)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Standard Deduction</p>
                    <p className="text-xl font-medium text-gray-800">{formatCurrency(taxResults.standardDeduction)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Taxable Income</p>
                    <p className="text-xl font-medium text-gray-800">{formatCurrency(taxResults.taxableIncome)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Total Tax</p>
                    <p className="text-xl font-bold text-red-600">{formatCurrency(taxResults.totalTax)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">After-Tax Income</p>
                    <p className="text-xl font-bold text-green-600">{formatCurrency(taxResults.afterTaxIncome)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Effective Tax Rate</p>
                    <p className="text-xl font-medium text-gray-800">{taxResults.effectiveRate}%</p>
                  </div>
                </div>
                
                <div className="mt-8">
                  <h3 className="text-lg font-medium mb-4">Tax Breakdown by Bracket</h3>
                  ...
                  <div className="mt-4 p-4 bg-yellow-50 rounded-lg text-sm text-yellow-800">
                    <p className="flex items-start">
                      ...
                      <span>
                        This is a simplified tax calculator for illustrative purposes. Actual tax calculations may include additional deductions, credits, and state/local taxes.
                      </span>
                    </p>
                  </div>
                </div>
              ...
              {showInfo && (
                ...
                >
                  <h3 className="font-medium text-gray-800 mb-2">Understanding Tax Terms:</h3>
                  <ul className="space-y-2">
                    <li>
                      <span className="font-medium text-gray-700">Gross Income:</span> Total income before any deductions or taxes.
                    </li>
                    <li>
                      <span className="font-medium text-gray-700">Standard Deduction:</span> A fixed amount that reduces your taxable income based on your filing status.
                    </li>
                    <li>
                      <span className="font-medium text-gray-700">Taxable Income:</span> The amount of income subject to taxes after deductions.
                    </li>
                    <li>
                      <span className="font-medium text-gray-700">Marginal Tax Rate:</span> The tax rate applied to your last dollar of income (your highest tax bracket).
                    </li>
                    <li>
                      <span className="font-medium text-gray-700">Effective Tax Rate:</span> The average rate at which your income is taxed (total tax divided by gross income).
                    </li>
                  </ul>
                  
                  <h3 className="font-medium text-gray-800 mt-4 mb-2">How Progressive Tax Brackets Work:</h3>
                  <p className="mb-2">
                    The U.S. uses a progressive tax system, meaning different portions of your income are taxed at different rates. For example, if you're in the 22% tax bracket, not all of your income is taxed at 22% - only the portion that falls within that bracket.
                  </p>
                  ...
                  <p>
                    This calculator uses 2023 federal tax brackets and standard deductions. State taxes, itemized deductions, and tax credits are not included.
                  </p>
                </motion.div>
              )}
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ol className="space-y-2 text-gray-700 list-decimal list-inside">
                ...
                <li>Click "Calculate Taxes" to see your estimated tax breakdown</li>
                <li>Use the "Reset" button to start a new calculation</li>
              </ol>
            </div>
            <div>
              <h3 className="text-lg font-medium mb-2">Filing Status Explained</h3>
              <ul className="space-y-2 text-gray-700">
                <li><span className="font-medium">Single:</span> Unmarried individuals or married individuals who are legally separated</li>
                <li><span className="font-medium">Married Filing Jointly:</span> Married couples who combine their income</li>
                <li><span className="font-medium">Head of Household:</span> Unmarried individuals who pay more than half the cost of keeping up a home for a qualifying person</li>
              </ul>
            </div>
          </div>
          <div className="mt-6">
            ...
            <ul className="space-y-1 text-gray-700 list-disc list-inside">
              ...
              <li>The calculator uses the standard deduction and doesn't account for itemized deductions</li>
              <li>Tax credits like Child Tax Credit or Earned Income Credit are not included</li>
              <li>For comprehensive tax planning, consult a tax professional</li>
            </ul>
          </div>
        </div>
      </motion.div>
